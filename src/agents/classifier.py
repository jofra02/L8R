...
async def classifier_agent_node(state: GlobalState) -> Dict[str, Any]:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are an expert IT Support AI. Classify the following ticket into technical domains (e.g., 'network', 'auth', 'database', 'hardware'). Provide a confidence score (0-1)."),
