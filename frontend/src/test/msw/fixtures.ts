  ...
  const assets: Asset[] = [
    ...
    makeAsset({
      ...
      attributes: {
        ...
        license_status: { antivirus: { status: "expired" } },
        licenses: [
          { key: "antivirus", label: "Antivirus", category: "signature", status: "expired",
            state: "expired", expires: "2025-10-25T00:00:00+00:00", entitlement: "AVDB",
            seats: null, version: "93.04557", last_update: null, details: {} },
          { key: "web_filtering", label: "Web Filtering", category: "cloud_service",
            status: "licensed", state: "ok", expires: "2030-01-01T00:00:00+00:00",
            entitlement: "FURL", seats: null, version: null, last_update: null, details: {} },
          { key: "forticare", label: "FortiCare Registration", category: "registration",
            status: "registered", state: "ok", expires: null, entitlement: null,
            seats: null, version: null, last_update: null,
            details: { account: "x@example.com", company: "Fortinet" } },
          { key: "vdom", label: "Vdom", category: "platform", status: null,
            state: "unknown", expires: null, entitlement: null,
            seats: { used: 1, max: 10 }, version: null, last_update: null, details: {} },
        ],
      },
